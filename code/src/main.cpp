...
//     auto test=cv::Rect(0,0,1000,1000);
    for(auto idx:index) {
        ...
        ****************************************************************/
        ...
        su.superPixelNoise(SuperPixel::options::RandomSelectMostNeighbourRelabel);
        //save data
        su.saveColorImage("RandomSelectMostNeighbourRelabel");

        //random select, nearesst neighbors
        su.superPixelNoise(SuperPixel::options::RandomSelectNearestNeighbourRelabel);
        //save data
        su.saveColorImage("RandomSelectNearestNeighbourRelabel");
        ...
        su.superPixelNoise(SuperPixel::options::UncertaintyAreaSelectMostNeighbourRelabel);
        //save data
        su.saveColorImage("UncertaintyAreaSelectMostNeighbourRelabel");

        //uncertainty area select, nearest
        su.superPixelNoise(SuperPixel::options::UncertaintyAreaSelectNearestNeighbourRelabel);
        //save data
        su.saveColorImage("UncertaintyAreaSelectNearestNeighbourRelabel");
        ...
        su.superPixelNoise(SuperPixel::options::ObjectBorderSelectMostNeighbourRelabel);
        //save data
        su.saveColorImage("ObjectBorderSelectMostNeighbourRelabel");

        //boundary  select select, nearest
        su.superPixelNoise(SuperPixel::options::ObjectBorderSelectNearestNeighbourRelabel);
        //save data
        su.saveColorImage("ObjectBorderSelectNearestNeighbourRelabel");
#endif
